!function (t) {
    ...
    class n extends s.b {
        ...
        onInit() {
            ...
            a.position.set(-100, 250, -100), this.scene.add(a), this.camera = new THREE.PerspectiveCamera(20, this.width / this.height, 35, 1e4);
        ...
        onUpdate() {
            ...
            for (let t = 0; t < this.plane.geometry.vertices.length; t++) {
                ...
                if (e.oy) {
                    const t = this.options.waveSpeed, i = Math.sqrt(t) * Math.cos(-e.x - .7 * e.z),
    ...
    n.prototype.defaultOptions = {color: 21896, shininess: 30, waveHeight: 15, waveSpeed: 1, zoom: 1}, n.initClass()
}]);